        ...
        <div id="tour-8" class="sidebar-content" style="padding-top: 20px;">
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading"> Retail POS</h4>
        ...
        <ul id="tour-9" class="sidebar-menu">
            ...
            <li class="{{ Request::path() == 'pos' ? 'active' : '' }}">
                <a href="{{url('pos')}}">
                    ...
                    <span class="text">New Sales | POS</span>
                </a>
            </li>
            @endif
            ...
            <li class="submenu">
                ...
                <ul>
                    ...
                    <li class="{{ Request::path() == 'settings/barcode' ? 'active' : '' }} border-bottom-purple"><a href="{{url('/settings/barcode')}}" class="menu-item">Print Barcode</a></li>
            ...
            @if(in_array('storesettings', $dataMenuAssigned) || in_array('user', $dataMenuAssigned)) 
            <li class="submenu">
                <a href="javascript:void(0);">
