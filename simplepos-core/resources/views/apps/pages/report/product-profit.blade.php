...
<section id="form-action-layouts">
	...
	@endif
        ...
        <div class="col-lg-3 col-sm-12 bg-info bg-lighten-2 border-right-pink border-right-lighten-3">
            <div class="card-block text-xs-center">
                <h1 class="display-6 white"><i class="icon-trending_up font-large-2"></i> <b>Tk</b> {{$cost_total}}</h1>
        ...
        <div class="col-lg-3 bg-info bg-lighten-3 col-sm-12">
            <div class="card-block text-xs-center">
                <h1 class="display-6 white"><i class="icon-money font-large-2"></i> <b>Tk</b> {{$sold_total}}</h1>
                <span class="white">Total Sales</span>
            </div>
        </div>
        <div class="col-lg-3 bg-info bg-lighten-4 col-sm-12">
            <div class="card-block text-xs-center">
                <h1 class="display-6 white"><i class="icon-banknote font-large-2"></i> <b>Tk</b> {{$profit_total}}</h1>
