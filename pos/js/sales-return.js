                ...
                if(data.length > 0)
                {
                    $.each(data, function(key,row){
                        ...
                        if(row.item_return_status == 1){
                            ...
                            table_data +='              <input value="'+row.price+'" size="8" type="text" class="form-control form-control-info" placeholder="Enter Reason">';
                            table_data +='              <div class="form-control-position">';
                            table_data +='                  <i class="icon-dollar info"></i>';
                            table_data +='              </div>';
                            table_data +='          </fieldset>';
                            table_data +='    </td>';
                            table_data +='    <td>';
                            table_data +='          <fieldset class="form-group position-relative has-icon-left">';
                            table_data +='              <input value="Customer Want To Return"  size="20"  type="text" class="form-control form-control-info" placeholder="Enter Reason">';
                            table_data +='              <div class="form-control-position">';
                            table_data +='                  <i class="icon-phone3 info"></i>';
                            table_data +='              </div>';
                            table_data +='          </fieldset>';
                            table_data +='     </td>';
                            table_data +='     <td>';
                            table_data +='           <button onclick="SalesReturnItem('+row.id+','+key+')" type="button" class="btn btn-outline-info">';
                ...
                'success': function (data) 
                {
                    ...
                    if(data.length > 0)
                    {
                        $.each(data, function(key,row){
                            ...
                            table_data +='    <td>';
                            table_data +='           <button onclick="loadSalesReturnItem('+row.invoice_id+')" type="button" class="btn btn-outline-info">';
